...
const initialNodes: Node[] = [
    // GROUPS
    {
        ...
        type: 'compartment',
        position: { x: 50, y: 50 },
        style: { width: 900, height: 280, backgroundColor: 'rgba(56, 189, 248, 0.05)', border: '2px dashed #38bdf8', borderRadius: '12px' },
    ...
    },
    {
        ...
        style: { width: 400, height: 610, backgroundColor: 'rgba(250, 204, 21, 0.05)', border: '2px dashed #facc15', borderRadius: '12px' },
    ...
    },
    {
        ...
        style: { width: 320, height: 260, backgroundColor: 'rgba(168, 85, 247, 0.05)', border: '2px dashed #a855f7', borderRadius: '12px' },
    ...
    },
    {
        ...
        type: 'compartment',
        position: { x: 50, y: 750 },
        style: { width: 900, height: 400, backgroundColor: 'rgba(168, 85, 247, 0.05)', border: '2px dashed #a855f7', borderRadius: '12px' },
    ...
    // SHARED NETWORKING (Middle Center)
    {
        id: 'tf_apigw',
        parentId: 'grp-shared',
        position: { x: 50, y: 90 },
