...
const initialNodes: Node[] = [
  {
    ...
    type: 'compartment',
    position: { x: -760, y: 20 },
    style: { width: 520, height: 1610, backgroundColor: 'rgba(14, 165, 233, 0.05)', border: '2px dashed #0ea5e9', borderRadius: '18px', overflow: 'hidden' },
  ...
  },
  {
    ...
    parentId: 'grp-ado',
    position: { x: 24, y: 120 },
    style: { width: 470, height: 240, backgroundColor: 'rgba(56, 189, 248, 0.05)', border: '1px dashed #38bdf8', borderRadius: '14px', overflow: 'hidden' },
  ...
  },
  {
    ...
    parentId: 'grp-ado',
    position: { x: 24, y: 390 },
    style: { width: 470, height: 480, backgroundColor: 'rgba(20, 184, 166, 0.05)', border: '1px dashed #14b8a6', borderRadius: '14px', overflow: 'hidden' },
  ...
  },
  {
    ...
    parentId: 'grp-ado',
    position: { x: 24, y: 900 },
    style: { width: 470, height: 450, backgroundColor: 'rgba(34, 197, 94, 0.05)', border: '1px dashed #22c55e', borderRadius: '14px', overflow: 'hidden' },
  ...
  },
  {
    ...
    style: { width: 470, height: 140, backgroundColor: 'rgba(244, 114, 182, 0.05)', border: '1px dashed #f472b6', borderRadius: '14px', overflow: 'hidden' },
  ...
  },
  {
    ...
    type: 'compartment',
    position: { x: -160, y: 20 },
    style: { width: 430, height: 210, backgroundColor: 'rgba(234, 179, 8, 0.05)', border: '2px dashed #eab308', borderRadius: '18px', overflow: 'hidden' },
  ...
  },
  {
    ...
    style: { width: 1160, height: 420, backgroundColor: 'rgba(20, 184, 166, 0.05)', border: '2px dashed #14b8a6', borderRadius: '16px', overflow: 'hidden' },
  ...
  },
  {
    ...
    style: { width: 1160, height: 220, backgroundColor: 'rgba(56, 189, 248, 0.05)', border: '2px dashed #38bdf8', borderRadius: '16px', overflow: 'hidden' },
  ...
  },
  {
    ...
    style: { width: 430, height: 520, backgroundColor: 'rgba(59, 130, 246, 0.05)', border: '2px dashed #3b82f6', borderRadius: '18px', overflow: 'hidden' },
  ...
  },
  {
    ...
    style: { width: 720, height: 250, backgroundColor: 'rgba(34, 197, 94, 0.05)', border: '2px dashed #22c55e', borderRadius: '18px', overflow: 'hidden' },
  ...
  },
  {
    ...
    style: { width: 430, height: 220, backgroundColor: 'rgba(113, 113, 122, 0.08)', border: '2px dashed #71717a', borderRadius: '18px', overflow: 'hidden' },
...

  {
    ...
    type: 'topology',
    data: { resource: { name: 'Internet', type: 'gateway', details: 'Entrada publica', status: 'active' } },
  },
  {
    id: 'cloudflare',
    position: { x: 290, y: -90 },
...

  {
    ...
    position: { x: 140, y: 40 },
    type: 'topology',
    data: { resource: { name: 'Azure DevOps', type: 'box', details: 'Pipelines separadas por repositorio e por dominio', status: 'active' } },
  },
  ...
  },
  {
    ...
    type: 'topology',
    data: { resource: { name: 'Test_Crivo_Dev', type: 'loadbalancer', details: '10.8.4.127 | VIP / host routing MFE e MS', status: 'active' } },
  },
  {
    id: 'drg',
    parentId: 'grp-shared',
    position: { x: 105, y: 380 },
    type: 'topology',
    data: { resource: { name: 'DRG-Invista-Shared', type: 'gateway', details: 'Hub entre VCN-DEV e vcn-oke', status: 'manual' } },
  },

  {
    ...
    position: { x: 950, y: 70 },
    type: 'topology',
    data: { resource: { name: 'VCN-DEV', type: 'vcn', details: '10.6.0.0/16 | rede compartilhada', status: 'manual' } },
  },
  {
    id: 'apigw-dev',
    parentId: 'grp-dev-inv',
    ...
    type: 'topology',
    data: { resource: { name: 'api-gateway-dev', type: 'apigateway', details: 'PRIVATE | cmp-dev-inv | gateway unificado DEV', status: 'active' } },
  },
  {
    id: 'mfe-routes',
    parentId: 'grp-dev-inv',
    ...
    type: 'topology',
    data: { resource: { name: 'MFE routes', type: 'box', details: 'deploy-mfe-unified-dev | /mfe-shell /mfe-auth /mfe-user /mfe-person /mfe-poc /mfe-formalization', status: 'active' } },
  },
  {
    id: 'ms-routes',
    parentId: 'grp-dev-inv',
    ...
    type: 'topology',
    data: { resource: { name: 'MS routes', type: 'box', details: '/ms-auth-external /ms-auth-sso /ms-user /ms-person /ms-poc /ms-parameters /ms-belt /ms-notify /ms-barramento', status: 'active' } },
  },
...

  {
    ...
    position: { x: 105, y: 70 },
    type: 'topology',
    data: { resource: { name: 'api-gateway-nexus-dev', type: 'apigateway', details: 'DELETED em 2026-03-14 | removido do fluxo principal', status: 'inactive' } },
  },
];
...
export function NexusDiagram() {
  ...
  return (
    <div className="h-screen w-screen bg-zinc-950">
      ...
      >
        <Panel position="top-left" className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 text-white m-4 shadow-2xl max-w-[560px]">
          <h1 className="text-2xl font-black italic tracking-tighter flex items-center gap-2">
            <div className="w-3 h-3 bg-red-600 rounded-full animate-pulse" />
            NEXUS TOPOLOGY
          </h1>
          <p className="text-xs font-bold text-zinc-400 mt-1 uppercase tracking-widest">DEV atualizado em 2026-03-14 | layout v2</p>

          <div className="mt-4 flex gap-2 flex-wrap">
            <div className="px-2 py-1 bg-sky-500/20 text-sky-400 rounded text-[10px] font-bold border border-sky-500/30">Repos separados por bloco</div>
            ...
            <div className="px-2 py-1 bg-lime-500/20 text-lime-400 rounded text-[10px] font-bold border border-lime-500/30">Menos cruzamento</div>
          </div>
        </Panel>
        ...
        <Panel position="bottom-left" className="bg-zinc-900/90 backdrop-blur-md p-4 rounded-2xl border border-white/10 text-white m-4 shadow-2xl max-w-[460px]">
          ...
          <div className="text-[10px] text-zinc-300 leading-relaxed space-y-1">
            <p><span className="text-teal-400 font-bold">MFE routes</span>: fan-out de buckets sem sair com seis linhas diretamente do gateway.</p>
            <p><span className="text-orange-400 font-bold">MS routes</span>: agrega o tráfego interno antes de distribuir para os LBs.</p>
            <p><span className="text-zinc-400 font-bold">Legacy</span>: recursos desativados ficam fora do fluxo principal.</p>
            <p><span className="text-sky-400 font-bold">Repos</span>: separados por domínio, sem poluir o canvas com linhas desnecessárias.</p>
          </div>
        ...
        <Panel position="bottom-right" className="bg-zinc-900/80 p-4 rounded-xl border border-white/10 text-[10px] font-mono text-zinc-500 m-4 max-w-[420px]">
          SYSTEM_REPORT_ID: OCI-DEV-NEXUS-2026.03.14-r5 | legacy isolado | repos por bloco | gateway fan-out agrupado | menos sobreposicao visual
        </Panel>
